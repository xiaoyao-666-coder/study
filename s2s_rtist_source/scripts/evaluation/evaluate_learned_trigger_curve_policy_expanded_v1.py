...
SAMPLES = Path("Maize_shortterm_surrogate_expanded_v1/shortterm_surrogate_expanded_samples_v1.csv")
PRED = Path("Maize_shortterm_surrogate_expanded_v1/surrogate_tree_nosklearn_expanded_v1_predictions.csv")
OUT_DIR = Path("Maize_shortterm_surrogate_expanded_v1")
DECISION_OUT = OUT_DIR / "learned_trigger_curve_policy_expanded_v1_decision_eval.csv"
METRICS_OUT = OUT_DIR / "learned_trigger_curve_policy_expanded_v1_metrics.txt"
...
def main() -> None:
    ...
    lines = [
        "Learned trigger + amount policy expanded v1",
        "",
        f"samples: {SAMPLES}",
