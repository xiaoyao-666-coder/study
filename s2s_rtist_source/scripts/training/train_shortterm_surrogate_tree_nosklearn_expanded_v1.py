...
DATA = Path("Maize_shortterm_surrogate_expanded_v1/shortterm_surrogate_expanded_samples_v1.csv")
OUT_DIR = Path("Maize_shortterm_surrogate_expanded_v1")
PRED_OUT = OUT_DIR / "surrogate_tree_nosklearn_expanded_v1_predictions.csv"
DECISION_OUT = OUT_DIR / "surrogate_tree_nosklearn_expanded_v1_decision_eval.csv"
METRICS_OUT = OUT_DIR / "surrogate_tree_nosklearn_expanded_v1_metrics.txt"
...
def main() -> None:
    ...
    lines = [
        "Shortterm surrogate tree baseline without sklearn expanded v1",
        "",
        f"dataset: {DATA}",
        f"rows: {len(df)}",
